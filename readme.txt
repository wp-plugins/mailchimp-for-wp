...
There are several [add-on plugins for MailChimp for WordPress](https://mc4wp.com/), which help you get even more out of your site.
...
Use the WordPress.org forums for community support where we try to help all of our users. If you found a bug, please create an issue on Github where we can act upon them more efficiently.
